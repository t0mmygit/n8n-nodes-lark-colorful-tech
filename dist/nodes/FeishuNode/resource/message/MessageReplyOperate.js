...
const MessageReplyOperate = {
    ...
    async call(index) {
        ...
        const reply_in_thread = this.getNodeParameter('reply_in_thread', index);
        const body = {
            msg_type,
            content,
        };
...
exports.default = MessageReplyOperate;
//# sourceMappingURL=MessageReplyOperate.js.map