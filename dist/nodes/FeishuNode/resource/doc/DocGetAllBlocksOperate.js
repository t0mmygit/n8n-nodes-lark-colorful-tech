...
const DocGetAllBlocksOperate = {
    ...
    async call(index) {
        ...
        const page_size = this.getNodeParameter('page_size', index, 500);
...
exports.default = DocGetAllBlocksOperate;
//# sourceMappingURL=DocGetAllBlocksOperate.js.map