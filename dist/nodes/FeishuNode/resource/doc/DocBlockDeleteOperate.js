...
const DocBlockDeleteOperate = {
    ...
    async call(index) {
        ...
        const client_toke = this.getNodeParameter('client_toke', index, '');
        const qs = {
...
exports.default = DocBlockDeleteOperate;
//# sourceMappingURL=DocBlockDeleteOperate.js.map