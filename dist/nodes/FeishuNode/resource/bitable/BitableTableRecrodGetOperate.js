...
exports.default = {
    ...
    async call(index) {
        ...
        const with_shared_url = this.getNodeParameter('with_shared_url', index);
        const automatic_fields = this.getNodeParameter('automatic_fields', index);
...
//# sourceMappingURL=BitableTableRecrodGetOperate.js.map