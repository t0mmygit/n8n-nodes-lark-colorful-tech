...
exports.default = {
    ...
    options: [
        ...
        },
        {
            ...
            required: true,
            default: '{"fields":{}}',
            description: '参考：https://open.feishu.cn/document/server-docs/docs/bitable-v1/app-table-record/create#requestBody',
        },
    ],
    async call(index) {
...
//# sourceMappingURL=BitableTableRecrodAddOperate.js.map