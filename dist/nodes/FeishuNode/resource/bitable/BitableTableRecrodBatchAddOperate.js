...
exports.default = {
    ...
    options: [
        ...
        },
        {
            ...
            required: true,
            default: '{"records":[]}',
            description: '参考：https://open.feishu.cn/document/server-docs/docs/bitable-v1/app-table-record/batch_create#requestBody',
        },
    ],
    async call(index) {
...
//# sourceMappingURL=BitableTableRecrodBatchAddOperate.js.map