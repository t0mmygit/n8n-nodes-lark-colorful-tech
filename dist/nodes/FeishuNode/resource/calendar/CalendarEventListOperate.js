...
exports.default = {
    ...
    async call(index) {
        ...
        const pageSize = this.getNodeParameter('page_size', index, 500);
        const anchorTime = this.getNodeParameter('anchor_time', index, '');
        const pageToken = this.getNodeParameter('page_token', index, '');
        const syncToken = this.getNodeParameter('sync_token', index, '');
...
//# sourceMappingURL=CalendarEventListOperate.js.map