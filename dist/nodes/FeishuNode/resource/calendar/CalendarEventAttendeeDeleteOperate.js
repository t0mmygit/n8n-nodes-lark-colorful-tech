...
exports.default = {
    ...
    async call(index) {
        ...
        const attendeeIds = NodeUtils_1.default.getNodeJsonData(this, "attendee_ids", index);
        const deleteIds = NodeUtils_1.default.getNodeJsonData(this, "delete_ids", index);
...
//# sourceMappingURL=CalendarEventAttendeeDeleteOperate.js.map