...
const WikiSpacesAddMemberOperate = {
    ...
    async call(index) {
        ...
        const needNotification = this.getNodeParameter('need_notification', index);
        const body = {
...
exports.default = WikiSpacesAddMemberOperate;
//# sourceMappingURL=WikiSpacesMemberAddOperate.js.map