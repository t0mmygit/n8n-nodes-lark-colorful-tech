...
const SpreadsheetValuesReadOperate = {
    name: '读取单个范围',
    ...
    async call(index) {
        ...
        const valueRenderOption = this.getNodeParameter('valueRenderOption', index, '');
        const dateTimeRenderOption = this.getNodeParameter('dateTimeRenderOption', index, '');
        const userIdType = this.getNodeParameter('userIdType', index, 'lark_id');
        const qs = {};
        if (valueRenderOption)
            qs.valueRenderOption = valueRenderOption;
        if (dateTimeRenderOption)
            qs.dateTimeRenderOption = dateTimeRenderOption;
        if (userIdType)
...
exports.default = SpreadsheetValuesReadOperate;
//# sourceMappingURL=SpreadsheetValuesReadOperate.js.map